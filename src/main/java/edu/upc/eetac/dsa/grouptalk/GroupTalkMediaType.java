...
public class GroupTalkMediaType {
    ...
    public final static String GROUPTALK_GRUPO_COLLECTION = "application/vnd.dsa.coleccion.grupo+json";
    public final static String GROUPTALK_TEMA = "application/vnd.dsa.grouptalk.tema+json";
    public final static String GROUPTALK_TEMA_COLLECTION = "application/vnd.dsa.coleccion.tema+json";
    public final static String GROUPTALK_RESPUESTA = "application/vnd.dsa.grouptalk.respuesta+json";
    public final static String GROUPTALK_RESPUESTA_COLLECTION = "application/vnd.dsa.coleccion.respuesta+json";
